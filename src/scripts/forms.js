...
function init_form_events(){
    ...
    save_goal_btn.addEventListener("click", () => { save_goal(options_window); });
    cancel_goal_btn.addEventListener("click", () => { cancel_goal(options_window); })
}
